<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
		...
		<li>
          <a href= "<?= base_url('userskp');?>">
				<i class="fa fa-home"></i> <span>Profil PNS</span>
            <span class="pull-right-container">
...
<li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Rencana SKP</span>
            <span class="pull-right-container">
...
<li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Realisasi SKP</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
