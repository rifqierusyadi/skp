...
class Dataskp extends CI_Controller {
	...
	public $title = "DATA SKP ONLINE";
	public $subtitle = " DATA SKP ONLINE";
	public $folderview = "modules/dataskp/views/dataskp_view";
	public $folderform = "modules/dataskp/views/dataskp_form";
	...
	public function __construct()
	{
		...
		$this->load->model('Dataskp_model','database');
	}
	...
	private function _data()
	{
		$data = array(
			...
			'nip_dinilai' => $this->input->post('nip_dinilai'),
