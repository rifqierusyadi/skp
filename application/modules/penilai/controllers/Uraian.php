...
class Uraian extends CI_Controller {
	...
	{
		$data['head'] 		= 'Persetujuan Pengajuan Rencana Uraian Tugas';
	...
	{   
        $data['head'] 		= 'Detail Pengajuan Rencana Uraian Tugas';
	...
	public function ajax_list()
    {
        ...
        foreach ($record as $row) {
            ...
            $col[] = $row->periode;
            $col[] = status($row->nip, $row->periode);
    ...
    private function get_profil($id)
	{
		...
		//$profil_url = 'http://localhost/simpeg3/api/identitas?nip='.$id;
